...
<div id="parti-info">
	...
	<div id="profil" class="pm">
	
	</div>
	
	<div class="col-3-div">
	<div class="o"><strong>Partiordförande</strong> Fredrik Reinfeldt</div>
	<div class="o"><strong>Grundat</strong> 17 oktober 1904</div>
	<div class="o"><strong>Antal medlemmar</strong> 39 998 <i>(febr. 2014)</i></div>
	<div class="o"><strong>Politisk ideologi</strong> Liberalkonservatism</div>
	<div class="o"><strong>Politisk position</strong> Center-höger</div>
	<div class="o"><strong>Hemsida</strong> <a target="_blank" href="http://www.moderat.se/">www.moderat.se</a></div>
	</div>
...
<?php
                $myBucket = $client->bucket('moderaterna');
